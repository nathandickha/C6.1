...
export class CausticsSystem {
  ...
  applyToMaterial(mat) {
    ...
    // Preserve any shader patches that were already installed on this material
    // (section void clipping, spa/channel voids, orange interior clips, etc.).
    // Caustics used to replace onBeforeCompile completely, so a delayed
    // caustics/texture pass could wipe the section cut shader after a rebuild.
