...
export function createPoolWater(a, b, geometryOverride = null) {
  ...
  const uniforms = {
    ...
    normalMap3Strength: { value: 0.22 },
    normalTiling1: { value: 0.30 },
    normalTiling2: { value: 0.38 },
    normalTiling3: { value: 0.24 },
    normalSpeed1: { value: 0.035 },
    normalSpeed2: { value: 0.04 },
    normalOrbit3: { value: 0.05 },
    normalAngularSpeed3: { value: 0.225 },
    ...
    reflectionStrength: { value: 0.72 },
    reflectionPower: { value: 10.0 },
    ...
    reflectionNormalStrength: { value: 0.14 },
    reflectionDetailScale: { value: 1.0 },

    // Broad visible ripple shading, independent of the slow reflection.
    surfaceDetailStrength: { value: 0.55 },
    surfaceDetailNormalStrength: { value: 0.48 },
    ...
    absorption: { value: new THREE.Color(1.22, 0.76, 0.34) },
    absorptionStrength: { value: 0.12 },

    // Shallow/deep look controls
    shallowColor: { value: new THREE.Color(0.34, 0.94, 1.0) }, // visible aqua
    deepColor:    { value: new THREE.Color(0.00, 0.22, 0.88) }, // deeper blue

    alphaShallow: { value: 0.22 },
    alphaDeep:    { value: 0.34 },
